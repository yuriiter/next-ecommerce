      ...
      <g id="vuesax/linear/wifi-square">
        <g id="wifi-square">
          <g id="Group">
            <path
              id="Vector"
              d="M6 9.96001C9.63 7.15001 14.37 7.15001 18 9.96001"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
            ...
            <path
              id="Vector_2"
              d="M7.6001 13.05C10.2701 10.99 13.7401 10.99 16.4101 13.05"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            <path
              id="Vector_3"
              d="M9.80005 16.14C11.13 15.11 12.87 15.11 14.2 16.14"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
...
export const SearchFilterIcon = (props: IconProps) => {
  return (
    <svg
      {...props}
      width="24"
...
export const StarYellow = (props: IconProps) => {
  return (
    <svg
      width="18"
      height="16"
...
export const StarEmpty = (props: IconProps) => {
  return (
    <svg
      width="20"
      height="18"
